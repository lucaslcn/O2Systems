 ...
 * @author elias.flach
 */
public class LogDAO extends DAO implements IDAO_T<Log> {
...
//              Definir os dados das colunas
            ...
            Mensagens.retornoAcao(
                    Mensagens.problemaPopularTabela("Log")
...
//        580px tamanho da tabela
    ...
    @Override
    public Log consultarId(int id) {
        Object o = this.selectWithJoin("Log", "idlog = " + id).get(0);
        return (Log) o;
    }
