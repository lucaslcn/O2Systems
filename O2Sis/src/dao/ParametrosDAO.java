 ...
 * @author elias.flach
 */
public class ParametrosDAO extends DAO implements IDAO_T<Parametros> {
...
//              Definir os dados das colunas
            ...
            Mensagens.retornoAcao(
                    Mensagens.problemaPopularTabela("Parametros")
...
//        580px tamanho da tabela
    ...
    @Override
    public Parametros consultarId(int id) {
        Object o = this.selectWithJoin("Parametros", "idparametro = " + id).get(0);
        return (Parametros) o;
    }
