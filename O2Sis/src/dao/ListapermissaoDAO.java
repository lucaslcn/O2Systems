 ...
 */
public class ListapermissaoDAO extends DAO implements IDAO_T<Listapermissao> {
...
//        580px tamanho da tabela
    ...
    @Override
    public Listapermissao consultarId(int id) {
        Object o = this.selectWithJoin("Listapermissao", "idlistapermissao = " + id).get(0);
        return (Listapermissao) o;
    }
