 ...
 * @author elias
 */
public class AgendamentoExamesJIFiiii extends javax.swing.JInternalFrame implements BasicScreen{
     ...
     */
    public AgendamentoExamesJIFiiii(Usuario usuario) {
        initComponents();
        limpar();
        situacaoNovo();
    ...
    public void preencher() {
      paciente = ae.getIdpaciente();
       tfPaciente.setText(paciente.getIdpessoa().getNomePessoa());
      exame = ae.getIdexame();
       tf_Exame.setText(exame.getIdexame().getNomeExame());
